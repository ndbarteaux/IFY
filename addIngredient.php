...
if ($_FILES && isset ( $_FILES ["image"] )) {
	if ($_FILES ["image"] ["error"] == UPLOAD_ERR_OK) {
		if ($_FILES ["image"] ["size"] > 1000000) { /*To make sure people can overload our site*/
		...
		$error_msg = "An error occurred. Please try again. <!-- " . $_FILES ["image"] ["error"] . " -->";
	}
}

// On success, add ingredient to database
...
<!-- End of contents -->
<?php
/* Support functions for handling image upload above. Depends on format of image uploaded*/
