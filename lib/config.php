 ...
 */
class config {
	public $url_local    = '/s/bach/n/under/bpowley/public_html/project3/';
	public $url_public   = '/s/bach/n/under/bpowley/public_html/project3/';
	public $base_url     = '';  /* Selected below based upon server */
	public $site_name    = "CT 310: Project3";
	public $site_lmod    = "04/24/17";
	public $matience     = false;
	public $session_name = "CT310-P3";
	public $up_local     = "/s/bach/n/under/bpowley/public_html/project3/";
	public $up_public    = "/s/bach/n/under/bpowley/public_html/project3/assets/img/";
